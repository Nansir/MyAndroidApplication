package com.sir.app.retrofit.net.http;

import android.content.Context;
import android.util.Log;

import com.sir.app.retrofit.net.config.NetWorkConfiguration;
import com.sir.app.retrofit.net.cookie.SimpleCookieJar;
import com.sir.app.retrofit.net.interceptor.LogInterceptor;
import com.sir.app.retrofit.net.request.RetrofitClient;
import com.sir.app.retrofit.net.utils.NetworkUtil;
