...
public class UpdateUtil {
    private static final String TAG = "sir.update";
    private static final String PREFS = "sir.update.prefs";
    private static final String PREFS_IGNORE = "sir.update.prefs.ignore";
    private static final String PREFS_UPDATE = "sir.update.prefs.update";
