...
import com.sir.app.update.UpdateAgent;
import com.sir.app.update.UpdateInfo;
import com.sir.app.update.UpdateManager;
import com.sir.app.update.UpdateUtil;

/**
 * 程序更新
 * Created by zhuyinan on 2016/12/5.
 */
...
public class UpdateActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void check(boolean isManual, final boolean hasUpdate, final boolean isForce, final boolean isSilent, final boolean isIgnorable, final int notifyId) {
