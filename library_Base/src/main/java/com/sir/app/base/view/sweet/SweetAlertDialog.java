package com.sir.app.base.view.sweet;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public SweetAlertDialog(Context context, int alertType) {
        ...
        mErrorInAnim = OptAnimationLoader.loadAnimation(getContext(), R.anim.base_sweet_error_frame_in);
        mErrorXInAnim = OptAnimationLoader.loadAnimation(getContext(), R.anim.base_sweet_error_x_in);
        mSuccessBowAnim = OptAnimationLoader.loadAnimation(getContext(), R.anim.base_sweet_success_bow_roate);
        mSuccessLayoutAnimSet = (AnimationSet)OptAnimationLoader.loadAnimation(getContext(), R.anim.base_sweet_success_mask_layout);
        mScaleInAnim = (AnimationSet) OptAnimationLoader.loadAnimation(getContext(), R.anim.base_sweet_dialog_scale_in);
        mScaleOutAnim = (AnimationSet) OptAnimationLoader.loadAnimation(getContext(), R.anim.base_sweet_dialog_scale_out);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.base_sweet_dialog);
    ...
    private void restore () {
        ...
        mConfirmButton.setBackgroundResource(R.drawable.base_sweet_blue_button_background);
        ...
        if (mDialogView != null) {
            ...
            switch (mAlertType) {
                ...
                case SUCCESS_TYPE:
                    ...
                    break;
                case WARNING_TYPE:
                    mConfirmButton.setBackgroundResource(R.drawable.base_sweet_red_button_background);
