...
public class BaseHttp {
    ...
    public void get(Context context, String url, BinaryHttpResponseHandler handler) {
    ...
    public void download(final String downloadUrl, final String savePath, final String fileName, final OnDownloadListener listener) {
        // 指定文件类型
