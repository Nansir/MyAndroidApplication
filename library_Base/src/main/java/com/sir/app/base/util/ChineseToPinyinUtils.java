...
public class ChineseToPinyinUtils {
    ...
    private String TAG = ChineseToPinyinUtils.class.getSimpleName();
    ...
    private static ChineseToPinyinUtils characterParser;

    public static ChineseToPinyinUtils getInstance() {
        if (characterParser == null) {
            characterParser = new ChineseToPinyinUtils();
        }
