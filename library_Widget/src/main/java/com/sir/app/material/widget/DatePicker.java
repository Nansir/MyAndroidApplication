package com.sir.app.material.widget;
...
public class DatePicker extends ListView implements AbsListView.OnScrollListener {
    ...
    private class ScrollStateRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mNewState == SCROLL_STATE_IDLE && mPreviousScrollState != SCROLL_STATE_IDLE && mPreviousScrollState != SCROLL_STATE_TOUCH_SCROLL) {
