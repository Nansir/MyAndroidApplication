package com.sir.app.material.app;
...
import com.sir.app.material.R;
import com.sir.app.material.drawable.BlankDrawable;
import com.sir.app.material.widget.CheckBox;
import com.sir.app.material.widget.ListView;
import com.sir.app.material.widget.RadioButton;
import com.sir.app.material.widget.TextView;
...
public class SimpleDialog extends Dialog {
    ...
    private class InternalAdapter extends BaseAdapter implements com.sir.app.material.widget.CompoundButton.OnCheckedChangeListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            com.sir.app.material.widget.CompoundButton v = (com.sir.app.material.widget.CompoundButton) convertView;
            if (v == null) {
        ...
        public void onCheckedChanged(android.widget.CompoundButton v, boolean isChecked) {
            ...
            if (mMode == MODE_ITEMS && isChecked && mLastSelectedIndex != position) {
                ...
                com.sir.app.material.widget.CompoundButton child = (com.sir.app.material.widget.CompoundButton) mListView.getChildAt(mLastSelectedIndex - mListView.getFirstVisiblePosition());
                if (child != null)
