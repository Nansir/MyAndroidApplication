package com.space.app.base.util;
...
public class LiteOrmDBUtil {
	...
	public static void createDb(Context activity, Object userId) {
		DB_NAME = "sir_" + userId.toString() + ".db";
	...
	public static <T> List<T> getQueryByWhereLength(Class<T> cla, String field,
													Object[] value, int start, int length) {
		return liteOrm.<T> query(new QueryBuilder(cla).where(field + "=?",
	 ...
	 * @param value
	 */
	public static <T> void deleteWhere(Class<T> cla, String field,
									   Object[] value) {
