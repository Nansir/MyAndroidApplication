package com.sir.app.robot.aseven.widget;
...
import com.sir.app.robot.aseven.util.FABExpandAnimationUtils;
...
public class FABToolbarLayout extends RelativeLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            transitionDrawable = new TransitionDrawable(new Drawable[]{tempDrawable, getResources().getDrawable(R.drawable.fab_drawable, getContext().getTheme())});
        } else {
            transitionDrawable = new TransitionDrawable(new Drawable[]{tempDrawable, getResources().getDrawable(R.drawable.fab_drawable)});
        }
        ...
        fab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<Animator> expandAnim = FABExpandAnimationUtils.build(toolbarLayoutViewGroup, pivotX != -1 ? pivotX : toolbarLayout.getWidth() / 2, pivotY != -1 ? pivotY : toolbarLayout.getHeight() / 2, fraction, SHOW_ANIM_DURATION / 3, 2 * SHOW_ANIM_DURATION / 3);

                animators.addAll(expandAnim);


                // REVERSE EXPAND AND SHOW MENU ANIM
                List<Animator> expandAnimR = FABExpandAnimationUtils.buildReversed(toolbarLayoutViewGroup, pivotX != -1 ? pivotX : toolbarLayout.getWidth() / 2, pivotY != -1 ? pivotY : toolbarLayout.getHeight() / 2, fraction, HIDE_ANIM_DURATION / 3, 0);
